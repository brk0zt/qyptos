...
class SecurityDetector:
    def __init__(self):
        ...
        self.face_threshold = 0.7   # Yüz tespiti için eşik
        self.min_detections = 3     # Minimum art arda tespit sayısı
        self.detection_counter = 0  # Tespit sayacı
    ...
    def multi_method_lens_detection(self, frame):
        ...
        for method in methods:
            ...
            # EN AZ 2 METOD UYUM GÖSTERMELİ (Katı Kural)
    ...
    def _detect_bright_spots(self, frame):
        ...
        try:
            ...
            # Minimum parlak piksel sayısı
            bright_pixels = np.sum(bright_mask > 0)
            
            # YÜKSEK EŞİK: Frame'in %0.5'inden fazla parlak piksel olmalı
    ...
    def _detect_reflections(self, frame):
        ...
        try:
            ...
            # Çok yüksek parlaklık ve düşük doygunluk (lens yansıması)
            ...
            # Frame'in %0.3'ünden fazla yansıma olmalı
